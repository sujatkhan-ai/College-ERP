                ...
                [
                    ...
                    { "data": "Sl No" },
                    {
                        ...
                        data: null, render: function (data, type, row) {
                            return '<a href="#popup1"  onclick="GetEditEmp(' + data.empId + ')"> <i class="fa fa-pencil"></i></a>'
                        },
                        className: "center"
                    ...
                    },
                    {
                        data: null, render: function (data, type, row) {
                            ...
                            return '<a   onclick="DeletedEmp(' + data.empId + ')"> <i class="fa fa-trash"></i></a>'
                        },
                        className: "center"
                    ...
                    {
                        data: null, render: function (data, type, row) {
                            var resume = String(data.empResume);
                            console.log(resume);
                            return '<a href="/Recruit/GetFile/?id=' + data.empId + '"> <i class="fa fa-file-pdf-o" style="color:red"></i></a>'
                        },
                        className: "center"
